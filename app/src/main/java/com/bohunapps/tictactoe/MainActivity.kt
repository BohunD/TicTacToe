package com.bohunapps.tictactoe
...
import com.bohunapps.tictactoe.ui.theme.TicTacToeTheme
...
fun TTTScreen() {
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        if (!playerTurn.value && win.value == null) {
            CircularProgressIndicator(color = Color.Blue, modifier = Modifier.padding(16.dp))
...
@Composable
fun Board(moves: SnapshotStateList<Boolean?>, onTap: (Offset) -> Unit) {
    Box(
        modifier = Modifier
            .aspectRatio(1f)
            .padding(32.dp)
